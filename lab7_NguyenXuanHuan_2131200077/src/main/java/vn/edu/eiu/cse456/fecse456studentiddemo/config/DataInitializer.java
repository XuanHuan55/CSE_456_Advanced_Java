...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Student st1m1 = new Student("st1m1","Nguyen Xuan Huan",2003, 100);
        Student st2m1 = new Student("st2m1", "Nguyen Xuan Hao", 2002, 101);
        Student st3m2 = new Student("st3m2", "Le Thi Thao", 2000, 102);
        Student st4m2 = new Student("st4m2", "Le Minh Toan", 2001, 103);
